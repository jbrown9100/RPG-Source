...
public class Weapon extends Item{
	...
	public static Weapon generateNewWeapon() {
		Random rand = new Random();
		
		Material weaponMat = Material.allMaterials.get(rand.nextInt(Material.allMaterials.size()));
		Type weaponType = Type.allWeaponTypes.get(rand.nextInt(Type.allWeaponTypes.size()));
