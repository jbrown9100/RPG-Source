...
public class Potion extends Item{
	...
	public static final Potion standardHealth = new Potion("Minor Health Potion", 10, 20, 0);
	public static final Potion majorHealth = new Potion("Minor Health Potion", 10, 30, 0);
	
	//Mana pots
	public static final Potion minorMana = new Potion("Minor Health Potion", 10, 0, 10);
	public static final Potion standardMana = new Potion("Minor Health Potion", 10, 0, 20);
	public static final Potion majorMana = new Potion("Minor Health Potion", 10, 0, 30);
